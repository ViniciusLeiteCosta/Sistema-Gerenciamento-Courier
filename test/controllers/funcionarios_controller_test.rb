...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference("Funcionario.count") do
      post funcionarios_url, params: { funcionario: { cargo: @funcionario.cargo, cpf: @funcionario.cpf, data_nascimento: @funcionario.data_nascimento, email: @funcionario.email, nome: @funcionario.nome, telefone: @funcionario.telefone } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { cargo: @funcionario.cargo, cpf: @funcionario.cpf, data_nascimento: @funcionario.data_nascimento, email: @funcionario.email, nome: @funcionario.nome, telefone: @funcionario.telefone } }
