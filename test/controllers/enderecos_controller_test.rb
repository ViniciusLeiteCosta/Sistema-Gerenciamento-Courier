...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference("Endereco.count") do
      post enderecos_url, params: { endereco: { bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, codigo_postal: @endereco.codigo_postal, complemento: @endereco.complemento, logradouro: @endereco.logradouro, numero: @endereco.numero, pais: @endereco.pais } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, codigo_postal: @endereco.codigo_postal, complemento: @endereco.complemento, logradouro: @endereco.logradouro, numero: @endereco.numero, pais: @endereco.pais } }
